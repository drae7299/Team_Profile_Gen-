...
const newEngineer = () => {
  inquirer
    ...
    .then((answers) => {
      ...
      const newEmployee = new Manager(name, id, email, github);
      empArray.push(newEmployee);
 ...
 const newIntern = () => {
    inquirer.prompt([
        ...
        const newEmployee = new Manager(name, id, email, school);
        empArray.push(newEmployee);
        //new employee call back funtion to push data to array 
        newEmp();
      });
...
//                 <h3 class="card-subtitle mb-2 text-muted"></h2>
//             </div>
//             <div class="card-bottom">
//                 <p class="card-text">ID: </p>
//                 <p class="card-text">Email: <a class="card-link" href="mailto:fsdfdsfd"></a></p>
